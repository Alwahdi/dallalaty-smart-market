    ...
    <div className="min-h-screen bg-gradient-to-br from-primary/20 via-background to-secondary/20 flex items-center justify-center p-4 font-arabic" dir="rtl">
      <div className="w-full max-w-md">
        ...
        <Card>
          ...
          <CardContent>
            {/* Google Sign-In as Primary - More Prominent */}
            <div className="space-y-4">
              <Button 
                type="button" 
                className="w-full h-16 text-lg bg-gradient-to-r from-primary via-primary to-primary/90 hover:from-primary/90 hover:via-primary/90 hover:to-primary/80 text-primary-foreground border-0 shadow-xl hover:shadow-2xl transition-all duration-300 font-bold rounded-2xl" 
              ...
              >
                ...
                <span className="font-bold">متابعة مع Google</span>
              </Button>
              ...
              <div className="relative my-8">
                ...
                <div className="relative flex justify-center">
                  <button
                    type="button"
                    onClick={() => document.getElementById('email-tabs')?.scrollIntoView({ behavior: 'smooth' })}
                    className="bg-background px-4 py-1 text-xs text-muted-foreground hover:text-foreground transition-colors rounded-full border border-border/40 hover:border-border"
                  >
            ...
            <Tabs defaultValue="signin" className="w-full" id="email-tabs">
